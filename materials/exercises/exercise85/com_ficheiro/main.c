...
int main(int argc, char *argv[])
{
   	setlocale(LC_ALL,"");
	DADOS tAlunos[100];
	int nAlunosi=0,nAlunos,n, i;
	int op;

	lerFicheiro(tAlunos,&nAlunos);
	nAlunosi = nAlunos;
  ...
  do{
	...
	} else if (op==11){ // Ler do ficheiro
 		lerFicheiro(tAlunos,&nAlunos);
		printf("Leitura efetuada com sucesso\n");
	} else if (op==10){ // Escrita no ficheiro
		escreverFicheiro(tAlunos,nAlunos);
	} else {
